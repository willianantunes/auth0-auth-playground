...
from auth0_auth_playground.apps.core.apps import CoreConfig
...
ROOT_URLCONF = "auth0_auth_playground.urls"
...
WSGI_APPLICATION = "auth0_auth_playground.wsgi.application"
